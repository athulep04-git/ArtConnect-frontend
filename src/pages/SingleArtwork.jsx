            ...
            <div className="p-10 lg:p-14 flex flex-col justify-center">
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-8">
                <div className="bg-slate-50 rounded-2xl p-5 border border-slate-200">
                  ...
                  <p className="font-semibold text-lg">{artwork.category}</p>
                </div>

                <div className="bg-slate-50 rounded-2xl p-5 border border-slate-200">
                  <h4 className="text-sm text-gray-500 mb-2">Starting Price</h4>
                ...
                <div className="bg-slate-50 rounded-2xl p-5 border border-slate-200">
                  <h4 className="text-sm text-gray-500 mb-2">Posted On</h4>
              ...
              <div className="flex flex-wrap gap-4">
                <button
                  onClick={() => navigate("/artrequest")}
                  className="bg-gradient-to-r from-indigo-500 to-pink-500 text-white px-8 py-4 rounded-full font-semibold hover:scale-105 transition shadow-lg"
                >
                  Request Similar Artwork
                </button>

                <button
                  onClick={() => alert("Contact artist feature coming soon")}
                  className="bg-slate-200 text-gray-800 px-8 py-4 rounded-full font-semibold hover:bg-slate-300 transition"
                >
                  Contact Artist
                </button>
              </div>
